...
class CarbonSpider(scrapy.Spider):
    ...
    def parse(self, response):
        for product in response.css("div.ProductItem__Wrapper"):
            ...
            # Follow the link to the product page for more details
    ...
    def parse_product_details(self, response):
        ...
        # Extract SKU, selected color, available sizes, and size guide here
        ...
        # Yield the combined information
        yield {
            'Image_url': image,
            'Brand': brand,
